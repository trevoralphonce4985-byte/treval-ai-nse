   # main.py — Treval AI Financial Engine v2.1 (Cloud-Ready)
   ...
   app = FastAPI(
       ...
       version="2.1.0",
       description="Live NSE Stock Analysis API (Cloud Hosted)"
   )
   ...
   class Stock(BaseModel):
       ...
       pe_ratio: Optional[float] = None  # ✅ Fixed: Optional[float]
           ...
           for row in rows:
               ...
               stocks.append(
                   Stock(
                       ...
                       dividend_yield=4.5,
                       pe_ratio=None,  # ✅ Explicitly None — safe for Optional[float]
                       recommendation="HOLD"
                   )
               )
       ...
       for stock in stocks:
           ...
           picks.append(
               WealthPick(
                   ...
                   pe_ratio=stock.pe_ratio,  # ✅ Now safe: Optional[float]
